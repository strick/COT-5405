...
bagValue = fillKnapsack(item_values, item_weights, bagLimit)
#bagValue = fillKnapsack([1,6,18,22,28], [1,2,5,6,7], 11)
print("Your bag can carry a value of " + str(bagValue))
fp.write("<script>alert('Your bag can carry a value of " + str(bagValue) + "');</script>")
fp.write("</body></html>")
fp.close()
...
# DONE: Fix traceback
# Fix traceback header
# Add more inforamtion to find value 
# color codes
# Add more informaton to traceback
# Update readme
